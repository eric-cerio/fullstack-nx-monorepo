---
description: Project health dashboard. Reports coverage gaps, Nx boundary violations, undocumented features, console.log counts, stale migrations, and governance compliance.
---
...
1. **Coverage Gaps** — Run coverage checks and identify projects below threshold
2. **Boundary Violations** — Lint for `@nx/enforce-module-boundaries` violations
...
|-------|--------|---------|
| Coverage | PASS/WARN/FAIL | X/Y projects above threshold |
